...
<body class="g-sidenav-show  bg-gray-200">
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link text-white  active bg-gradient-primary " href="quanlyloai">
...
<div class="row">
 <div class="col-12">
     <div class="card shadow mb-4">
        <div class="card-body">
                  <form method="post" action="xuliloai" enctype="multipart/form-data">
                  <input type="hidden" name="id" value="<c:out value="${not empty loai ? loai.getMaloai() : ''}" />">
                    <c:if test="${empty loai}">
                   <div class="form-group">
                       <label> Mã loại: </label>
                       <c:choose>
                       <c:when test="${not empty loai }">
                       		${loai.getMaloai() }
                       </c:when>
                       <c:otherwise>
                   ...
                   <div class="form-group">
                       ...
                       <input type="text" name="tenloai" value="<c:out value="${not empty loai ? loai.getTenloai() : ''}" />">
                   </div>
    
                   <div class="form-group">
                   <label>Ảnh:</label>
                 	<input type="file" name="upload" value="<c:out value="${not empty loai ? loai.getAnhbanner() : ''}" />">
                     </div>
                   <a href="quanlyloai" class="btn btn-danger"> Trở lại </a>
