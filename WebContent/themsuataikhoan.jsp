  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-white active bg-gradient-primary" href="quanlytaikhoan">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
...
<div class="row">
 <div class="col-12">
     <div class="card shadow mb-4">
        <div class="card-body">
                  <form method="post" action="xulitaikhoan">
                  <input type="hidden" name="id" value="<c:out value="${not empty dangnhapct ? dangnhapct.getTendn() : ''}" />">
                    <c:if test="${empty dangnhapct}">
                   <div class="form-group">
                       <label> Tên đăng nhập : </label>
                       <c:choose>
                       <c:when test="${not empty dangnhapct }">
                       		${dangnhapct.getTendn() }
                       </c:when>
                       <c:otherwise>
                   ...
                   <div class="form-group">
                       ...
                       <input type="password" name="matkhau" value="<c:out value="${not empty dangnhapct ? dangnhapct.getMatkhau() : ''}" />">
                   </div>
    				 <div class="form-group">
                       <label> Quyền : </label>
                       <input type="text" name="quyen" value="<c:out value="${not empty dangnhapct ? dangnhapct.getQuyen() : ''}" />">
                   </div>
                   
                   <a href="quanlytaikhoan" class="btn btn-danger"> Trở lại </a>
